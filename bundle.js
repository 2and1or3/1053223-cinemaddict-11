...
/* harmony import */ var _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/film-adapter.js */ "./src/models/film-adapter.js");
...
class API {
  ...
  getFilms() {
    ...
    return this._getRequest(headers, MOVIES_POSTFIX)
            ...
            .then((films) => _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilms(films))
            .catch((err) => {
              throw new Error(err);
            });
  }
  ...
  updateFilm(newFilm) {
    ...
    newFilm = _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAWFilm(newFilm);
    const body = JSON.stringify(newFilm);

    return this._getRequest(headers, url, Methods.PUT, body)
            .then((response) => response.json())
            .then((film) => _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm(film))
            .catch((err) => {
              throw new Error(err);
            });
  }
  ...
  getCommentsByFilmId(id) {
    ...
    return this._getRequest(headers, url)
            .then((response) => response.json())
            .then((comments) => _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseComments(comments))
            .catch((err) => {
              throw new Error(err);
            });
  }
  ...
  addComment(filmId, newComment) {
    ...
    newComment = _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAWComment(newComment);
    ...
    return this._getRequest(headers, url, Methods.POST, body)
            ...
            .then((filmAndComments) => {
              const localFilm = {
                movie: _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm(filmAndComments.movie),
                comments: _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseComments(filmAndComments.comments),
              };
  ...
  sync(films) {
    ...
    films = films.map((film) => _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAWFilm(film));
...
class Store {
  ...
  setItems(items) {
    const rawItems = items.map((item) => _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAWFilm(item));
  ...
  getItems() {
    ...
    const localItems = _models_film_adapter_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilms(rawItems);
...
class AbstractComponent {
  constructor() {
    if (new.target === AbstractComponent) {
      throw new Error(_const_js__WEBPACK_IMPORTED_MODULE_1__["Errors"].INSTANCE);
    }
  ...
  getTemplate() {
    throw new Error(_const_js__WEBPACK_IMPORTED_MODULE_1__["Errors"].IMPLEMENT_GET_TEMPLATE);
  }
...
const createCardTemplate = (film, commentsLenght) => {
  ...
  const year = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["yearCardFormat"])(date);
  const filmDuration = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["durationFormat"])(duration);
...
class Card extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
    this._film = film;
  }
  ...
  setOpenClickHandlers(cb) {
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["addListeners"])(cb, poster, title, comment);
  }
...
class ContentContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const getCommentTemplate = (comment) => {
  ...
  const commentDate = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["dateCommentFormat"])(date);
...
const createDetailsPopuptemplate = (film, comments) => {
  ...
  const dateFormated = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["dateDetailsFormat"])(date);
  const filmDuration = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["durationFormat"])(duration);
...
class Details extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setAddCommentHandler(cb) {
    ...
    const onKeyDown = (evt) => {
      ...
      if (isAllPressed) {
        ...
        if (!isEmpty) {
          newComment.text = he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(newText);
...
class FilmsExtra extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(title) {
    super();
    this._title = title;
...
/* harmony default export */ __webpack_exports__["default"] = (FilmsExtra);
...
class FooterStatistic extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony default export */ __webpack_exports__["default"] = (FooterStatistic);
...
class LoadButton extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    ...
    container.addEventListener(`click`, (evt) => {
      ...
      if (isLink(evt)) {
        ...
        if (isStatistic) {
          ...
          cb(_const_js__WEBPACK_IMPORTED_MODULE_1__["ScreenIds"].STATISTIC);
        } else {
          statisticControl.classList.remove(ACTIVE_CLASS);
          cb(_const_js__WEBPACK_IMPORTED_MODULE_1__["ScreenIds"].CARDS);
        }
      }
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (NoFilms);
...
const createProfileTemplate = (profileHistory) => {
  const {count} = profileHistory;
  const userStatus = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getUserStatus"])(count);
...
class Profile extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  render() {
    this._user.count = this._filmsModel.get(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].HISTORY).length;

    if (!this._element) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this);
    } else {
      this.rerender();
    }
  }
...
/*!********************************!*\
  !*** ./src/components/sort.js ***!
  \********************************/
/*! exports provided: default, SortTypes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createStatisticTemplate = (statistic, currentPeriod) => {
  ...
  const status = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getUserStatus"])(allWatched.length);
...
class Statistic extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _drawChart() {
    ...
    const myChart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(statisticCtx, {
  ...
  _isInPeriod(date) {
    ...
    const beginPeriod = moment__WEBPACK_IMPORTED_MODULE_4___default()().add(-PERIODS[this._currentPeriod].range, `days`);
  ...
  _periodChangeHandler() {
    ...
    container.addEventListener(`click`, (evt) => {
      ...
      const id = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["parsePrefixId"])(PERIOD_PREFIX, evt.target.id);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: FilterTypes, RenderMethods, Errors, ScreenIds, USER_STATUSES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilterTypes", function() { return FilterTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderMethods", function() { return RenderMethods; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Errors", function() { return Errors; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScreenIds", function() { return ScreenIds; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "USER_STATUSES", function() { return USER_STATUSES; });
const FilterTypes = {
  ALL: `all`,
  WATCHLIST: `watchlist`,
  HISTORY: `history`,
...
/* harmony import */ var _components_details_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/details.js */ "./src/components/details.js");
...
class CardController {
  ...
  _onEscPress(evt) {
    if (Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["isEscPress"])(evt)) {
  ...
  _initDetails(comments) {
    this._detailsComponent = new _components_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._film, comments);
  ...
  render() {
    this._cardComponent = new _components_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._film);

    Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._cardComponent);
  ...
  destroy() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["removeComponent"])(this._cardComponent);

    if (this._detailsComponent) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["removeComponent"])(this._detailsComponent);
    }
  }
}

/* harmony default export */ __webpack_exports__["default"] = (CardController);
...
const filters = {
  [_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].ALL]: {
    title: `All movies`,
    count: null,
  },
  [_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].WATCHLIST]: {
    title: `Watchlist`,
    count: null,
  },
  [_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].HISTORY]: {
    title: `History`,
    count: null,
  },
  [_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].FAVORITE]: {
    title: `Favorite`,
    count: null,
  },
};
...
class FilterController {
  constructor(container, filmsModel) {
    ...
    this._currentFilter = _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].ALL;
  ...
  _update() {
    this._filters[_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].WATCHLIST].count = this._filmsModel.get(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].WATCHLIST).length;
    this._filters[_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].FAVORITE].count = this._filmsModel.get(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].FAVORITE).length;
    this._filters[_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].HISTORY].count = this._filmsModel.get(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterTypes"].HISTORY).length;
  }
  ...
  _rerender() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["removeComponent"])(this._menuComponent);
    this.render();
  ...
  render() {
    ...
    this._menuComponent = new _components_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._filters, this._currentFilter);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._menuComponent, _const_js__WEBPACK_IMPORTED_MODULE_2__["RenderMethods"].PREPEND);
...
/* harmony default export */ __webpack_exports__["default"] = (FilterController);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_load_button_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/load-button.js */ "./src/components/load-button.js");
...
/* harmony import */ var _components_content_container_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/content-container.js */ "./src/components/content-container.js");
...
/* harmony import */ var _components_no_films_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/no-films.js */ "./src/components/no-films.js");
/* harmony import */ var _components_loading_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/loading.js */ "./src/components/loading.js");
/* harmony import */ var _components_films_extra_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/films-extra.js */ "./src/components/films-extra.js");
/* harmony import */ var _card_controller_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./card-controller.js */ "./src/controllers/card-controller.js");
...
const SORT_FUNCTIONS = {
  [_components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].DATE]: (leftFilm, rightFilm) => new Date(rightFilm.date) - new Date(leftFilm.date),
  [_components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].RATING]: (leftFilm, rightFilm) => rightFilm.rating - leftFilm.rating,
  [_components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].COMMENT]: (leftFilm, rightFilm) => rightFilm.comments.length - leftFilm.comments.length,
};
...
class PageController {
  constructor(container, api, filmsModel, commentsModel) {
    ...
    this._contentContainerComponent = new _components_content_container_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._noFilmsComponent = new _components_no_films_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._filmsListComponent = new _components_films_list_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._loadButtonComponent = new _components_load_button_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._loadingComponent = new _components_loading_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  ...
  _renderLoading() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._container, this._sortComponent);
    this._sortComponent.setSortClickHandler(this._sortClickHandler);

    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._container, this._contentContainerComponent);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._contentContainerComponent.getElement(), this._loadingComponent);
  }
    ...
    const controllers =
      films
        .map((film) => {
          ...
          new _card_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](container,
              film,
              this._api,
              this._commentsModel,
              this._onDataChange,
  ...
  _loadButtonHandler(evt) {
    ...
    if (isfilmsEnd) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["removeComponent"])(this._loadButtonComponent);
    }
  }
  ...
  _repeatRender(sortType) {
    ...
    if (isEmptyData) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["replace"])(this._noFilmsComponent, this._filmsListComponent);
    } else {

      if (this._container.contains(this._noFilmsComponent.getElement())) {
        Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["replace"])(this._filmsListComponent, this._noFilmsComponent);
      }
  ...
  _renderExtra() {
    ...
    topRateFilms.sort(SORT_FUNCTIONS[_components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].RATING]);
    topCommentFilms.sort(SORT_FUNCTIONS[_components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].COMMENT]);
    ...
    if (!(this._filmsExtraComponentRate || this._filmsExtraComponentComment)) {
      this._filmsExtraComponentRate = new _components_films_extra_js__WEBPACK_IMPORTED_MODULE_6__["default"](ExtraTypes.TOP);
      this._filmsExtraComponentComment = new _components_films_extra_js__WEBPACK_IMPORTED_MODULE_6__["default"](ExtraTypes.MOST);

      if (maxRating) {
        Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._contentContainerComponent.getElement(), this._filmsExtraComponentRate);
      }

      if (maxCommentsLength) {
        Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._contentContainerComponent.getElement(), this._filmsExtraComponentComment);
      }
    }
  ...
  _renderLoadButton() {
    ...
    if (isMoreThanStep) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsListComponent.getElement(), this._loadButtonComponent);
  ...
  render() {
    ...
    if (isEmptyData) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["replace"])(this._noFilmsComponent, this._loadingComponent);
    } else {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["replace"])(this._filmsListComponent, this._loadingComponent);
  ...
  resetCurrentSort() {
    this._repeatRender(_components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].DEFAULT);
...
/* harmony import */ var _components_footer_statistic_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/footer-statistic.js */ "./src/components/footer-statistic.js");
...
/* harmony import */ var _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/page-controller.js */ "./src/controllers/page-controller.js");
/* harmony import */ var _controllers_filters_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/filters-controller.js */ "./src/controllers/filters-controller.js");
/* harmony import */ var _models_films_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/films.js */ "./src/models/films.js");
/* harmony import */ var _models_comments_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/comments.js */ "./src/models/comments.js");
/* harmony import */ var _api_api_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./api/api.js */ "./src/api/api.js");
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
...
const onScreenChange = (screenId) => {
  switch (screenId) {
    case _const_js__WEBPACK_IMPORTED_MODULE_11__["ScreenIds"].STATISTIC:
      pageController.hide();
      pageController.resetCurrentSort();
      statisticComponent.show();
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_11__["ScreenIds"].CARDS:
...
const commentsModel = new _models_comments_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_7__["default"](TOKEN);
const storage = new _api_store_js__WEBPACK_IMPORTED_MODULE_9__["default"](STORAGE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_8__["default"](api, storage);
const filmsModel = new _models_films_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

const profileComponent = new _components_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](header, filmsModel);
const filtersController = new _controllers_filters_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](main, filmsModel);
const statisticComponent = new _components_statistic_js__WEBPACK_IMPORTED_MODULE_2__["default"](main, filmsModel);
const pageController = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](main, apiWithProvider, filmsModel, commentsModel);
...
.then(() => {
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_10__["render"])(footer, new _components_footer_statistic_js__WEBPACK_IMPORTED_MODULE_1__["default"](quantityOfFilms));
})
.catch((err) => {
  filmsModel.set([]);
  throw new Error(err);
...
/* harmony default export */ __webpack_exports__["default"] = (FilmAdapter);
...
const FILTER_FUNCTIONS = {
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterTypes"].ALL]: () => true,
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterTypes"].WATCHLIST]: (film) => film.isWatchList,
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterTypes"].HISTORY]: (film) => film.isWatched,
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterTypes"].FAVORITE]: (film) => film.isFavorite,
};
...
class Films {
  constructor() {
    ...
    this._currentFilter = _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterTypes"].ALL;
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: getRandomInteger, dateDetailsFormat, durationFormat, dateCommentFormat, createElement, render, removeComponent, addListeners, isEscPress, yearCardFormat, getUserStatus, parsePrefixId, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomInteger", function() { return getRandomInteger; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dateDetailsFormat", function() { return dateDetailsFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "durationFormat", function() { return durationFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dateCommentFormat", function() { return dateCommentFormat; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEscPress", function() { return isEscPress; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "yearCardFormat", function() { return yearCardFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUserStatus", function() { return getUserStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parsePrefixId", function() { return parsePrefixId; });
...
const yearCardFormat = (date) => {
  const year = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`YYYY`);
  return year;
};

const dateDetailsFormat = (date) => {
  const detailsDate = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`DD MMMM YYYY`);
...
const durationFormat = (minutes) => {
  const duration = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(minutes, `minutes`);
...
const render = (target, component, method = _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderMethods"].APPEND) => {

  switch (method) {
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderMethods"].PREPEND:
      target.prepend(component.getElement());
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderMethods"].APPEND:
      target.append(component.getElement());
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderMethods"].AFTER:
...
const getUserStatus = (watchedQuantity) => {
  const userStatus = _const_js__WEBPACK_IMPORTED_MODULE_0__["USER_STATUSES"].find((status) => watchedQuantity >= status.minStatusEdge);
